...
Version  : 1.8.5
Release  : 31
URL      : http://archive.xfce.org/src/xfce/thunar/1.8/Thunar-1.8.5.tar.bz2
Source0  : http://archive.xfce.org/src/xfce/thunar/1.8/Thunar-1.8.5.tar.bz2
...
export LANG=C
export SOURCE_DATE_EPOCH=1558211039
export AR=gcc-ar
