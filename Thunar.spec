...
Source0  : https://archive.xfce.org/src/xfce/thunar/4.16/thunar-4.16.10.tar.bz2
...
%prep
%setup -q -n thunar-4.16.10
cd %{_builddir}/thunar-4.16.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632182662
...
cp %{_builddir}/thunar-4.16.10/COPYING %{buildroot}/usr/share/package-licenses/Thunar/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/thunar-4.16.10/COPYING.LIB %{buildroot}/usr/share/package-licenses/Thunar/86207ea3fdd7e8ef5ea34ca9d12a511dc7272d31
%make_install
%find_lang thunar
