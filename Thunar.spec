...
Source0  : https://archive.xfce.org/src/xfce/thunar/4.20/thunar-4.20.1.tar.bz2
...
%prep
%setup -q -n thunar-4.20.1
cd %{_builddir}/thunar-4.20.1
pushd ..
cp -a thunar-4.20.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735661564
