...
Version  : 4.18.8
Release  : 59
URL      : https://archive.xfce.org/src/xfce/thunar/4.18/thunar-4.18.8.tar.bz2
Source0  : https://archive.xfce.org/src/xfce/thunar/4.18/thunar-4.18.8.tar.bz2
...
%prep
%setup -q -n thunar-4.18.8
cd %{_builddir}/thunar-4.18.8
pushd ..
cp -a thunar-4.18.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698187668
