...
Source0  : http://archive.xfce.org/src/xfce/thunar/1.8/Thunar-1.8.1.tar.bz2
Summary  : A library to create Thunar extensions
Group    : Development/Tools
License  : GPL-2.0 LGPL-2.0
Requires: Thunar-bin
Requires: Thunar-config
Requires: Thunar-lib
Requires: Thunar-data
Requires: Thunar-license
...
%package config
Summary: config components for the Thunar package.
Group: Default

%description config
config components for the Thunar package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1533058357
...
export SOURCE_DATE_EPOCH=1533058357
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/Thunar
cp COPYING %{buildroot}/usr/share/doc/Thunar/COPYING
cp COPYING.LIB %{buildroot}/usr/share/doc/Thunar/COPYING.LIB
%make_install
%find_lang Thunar
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/Thunar/COPYING
/usr/share/doc/Thunar/COPYING.LIB
