...
%prep
%setup -q -n thunar-4.16.0
cd %{_builddir}/thunar-4.16.0
...
cp %{_builddir}/thunar-4.16.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/Thunar/86207ea3fdd7e8ef5ea34ca9d12a511dc7272d31
%make_install
%find_lang thunar
