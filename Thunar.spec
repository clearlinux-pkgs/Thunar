...
Version  : 4.18.2
Release  : 53
URL      : https://archive.xfce.org/src/xfce/thunar/4.18/thunar-4.18.2.tar.bz2
Source0  : https://archive.xfce.org/src/xfce/thunar/4.18/thunar-4.18.2.tar.bz2
...
%prep
%setup -q -n thunar-4.18.2
cd %{_builddir}/thunar-4.18.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673459001
