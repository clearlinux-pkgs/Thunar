...
Source0  : https://archive.xfce.org/src/xfce/thunar/4.18/thunar-4.18.11.tar.bz2
...
%prep
%setup -q -n thunar-4.18.11
cd %{_builddir}/thunar-4.18.11
pushd ..
cp -a thunar-4.18.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722448292
