...
Source0  : https://archive.xfce.org/src/xfce/thunar/4.18/thunar-4.18.4.tar.bz2
...
%prep
%setup -q -n thunar-4.18.4
cd %{_builddir}/thunar-4.18.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677190681
