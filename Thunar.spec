...
Version  : 4.20.2
Release  : 64
URL      : https://archive.xfce.org/src/xfce/thunar/4.20/thunar-4.20.2.tar.bz2
Source0  : https://archive.xfce.org/src/xfce/thunar/4.20/thunar-4.20.2.tar.bz2
...
%prep
%setup -q -n thunar-4.20.2
cd %{_builddir}/thunar-4.20.2
pushd ..
cp -a thunar-4.20.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739205305
